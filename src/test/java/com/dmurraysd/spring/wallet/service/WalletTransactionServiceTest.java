...
class WalletTransactionServiceTest {
    ...
    void shouldSaveTransaction() {
        ...
        WalletTransaction walletTransaction = walletTransactionService.saveTransaction(wallet.walletId(), fundTransferRequest, TransactionStatus.SUCCESS).get();
    ...
    void shouldGetAllTransactionsByWalletId() {
        ...
        List<WalletTransaction> walletTransaction = walletTransactionService.getAllTransactionsByWalletId(wallet.walletId());
